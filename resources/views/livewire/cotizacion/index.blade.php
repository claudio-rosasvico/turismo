                    ...
                    <tbody>
                        @foreach ($cotizaciones as $cotizacion)
                            <tr wire:key="{{ $cotizacion->id }}">
                                ...
                                <td>
                                    @if (!$cotizacion->activo || (isset($cotizacion->contrato) && !$cotizacion->contrato->activo))
                                ...
                                <td class="text-center">
                                    @if ($cotizacion->activo)
                                        @if ($cotizacion->fecha_reso_adjudicacion && !$cotizacion->contrato)
                                        ...
                                        @elseif ($cotizacion->fecha_llamado && !$cotizacion->contrato)
                                            <a class="me-2" style="cursor: pointer;"
                                            ...
                                            @if ($cotizacion->proveedores->count() > 2 && $cotizacion->fecha_llamado)
                                                ...
                                                <a class="me-2" style="cursor: pointer;"
                                                    wire:click="generarSobres({{ $cotizacion->id }})"
                                            ...
                                            @endif
                                        @elseif ($cotizacion->fecha_autorizacion && $cotizacion->items->count() > 0)
                                            <a class="me-2" style="cursor: pointer;"
                                                wire:click="showDescripcionAnexo({{ $cotizacion->id }})"
                                                title="Imprimir Pliego">
                                                <i class="fa-solid fa-file"></i></a>
                                ...
                                <td>
                                    ...
                                    @if (!$cotizacion->activo)
                                        <a class="text-danger me-1" style="cursor: pointer;"
                                            wire:click="updateActivo(true, {{ $cotizacion->id }})"
                                            title="Activar Cotizacion">
                                            <i class="fa-solid fa-square-xmark"></i></a>
                                    @elseif($cotizacion->activo && $cotizacion->fecha_reso_adjudicacion)
                                        <a class="text-success me-1" style="cursor: pointer;"
                                            wire:click="updateActivo(false, {{ $cotizacion->id }})"
        ...
        <div class="col-2">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Descripción de Anexo</h5>
                                    <button type="button" class="btn-close" wire:click="closeModal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="col-12">
                                        <label for="descripcion_anexo" class="form-label">Descripción de Anexo</label>
                                        <textarea type="text" class="form-control" name="descripcion_anexo" id="descripcion_anexo"
                                            aria-describedby="helpId" placeholder="" wire:model="descripcion_anexo"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        wire:click="generarAnexo">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col col-lg-4">
                                                ...
                                                <input type="text" class="form-control" name="expediente"
                                                    id="expediente" aria-describedby="helpId" placeholder=""
                                            ...
                                            <div class="col col-lg-4">
                                                ...
                                                <input type="text" class="form-control" name="nro_resolucion"
                                                    ...
                                                    value="{{ $cotizacion_contrato->nro_reso_adjudicacion }}" />
                                            </div>
                                            <div class="col col-lg-4">
                                            ...
                                            <div class="col col-lg-6">
                                                ...
                                                <input type="date" class="form-control" name="fecha_fin"
                                                    id="fecha_fin" aria-describedby="helpId" placeholder="" />
                                            </div>
                                            <div class="col col-lg-6">
            ...
            @if ($modalShowOfertas)
                <div>
                    ...
                    <div class="modal fade show" id="modal-default" tabindex="-1" role="dialog"
                        aria-labelledby="modal-default" aria-modal="true" style="display: block;">
                        <div class="modal-dialog ofertas modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
