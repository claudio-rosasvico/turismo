  <section class="h-100-vh mb-8">
      <div class="page-header align-items-start section-height-50 pt-5 pb-11 m-3 border-radius-lg"
          style="background-image: url('../assets/img/turismo_naturaleza.png');">
              ...
              <div class="row justify-content-center">
                  <div class="col-lg-5 text-center mx-auto">
                      ...
                      <p class="text-lead text-white">
                          {{ __('Sistema de Gestión de la Secretaría de Turismo de Entre Ríos') }}
                      </p>
                  </div>
              </div>
          </div>
                  ...
                  <div class="card z-index-0">
                      ...
                      <div class="card-body">
                          ...
                          <form wire:submit="register" action="#" method="POST" role="form text-left">
                              ...
                              <div class="form-check form-check-success text-left">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"
                                      checked>
                                  <label class="form-check-label" for="flexCheckDefault">
                                      {{ __('Acepto') }} <a href="javascript:;"
                                          class="text-success font-weight-bolder">{{ __('Términos y condiciones') }}</a>
                                  </label>
                              </div>
                              <div class="text-center">
                                  <button type="submit" class="btn bg-gradient-success w-100 my-4 mb-2">Registrarse</button>
                              </div>
                              <p class="text-sm mt-3 mb-0">{{ __('¿Ya tenés una cuenta? ') }}<a
                                      href="{{ route('login') }}"
